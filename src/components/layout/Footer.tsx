      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/privacy" className="text-[#6b6b8a] hover:text-[#f0a500] text-sm transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-[#6b6b8a] hover:text-[#f0a500] text-sm transition-colors">Terms of Service</Link></li>
              <li><Link href="/cookies" className="text-[#6b6b8a] hover:text-[#f0a500] text-sm transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
