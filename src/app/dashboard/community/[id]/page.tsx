          ...
          >
            ...
            >
              ...
              <p className="mb-5 text-sm text-[#6b6b8a]">
                Start a practice server on <span className="text-[#e8e8e8] font-medium">{map?.displayName}</span> with collection <span className="text-[#f0a500] font-medium">"{collection?.name}"</span>?
              </p>
